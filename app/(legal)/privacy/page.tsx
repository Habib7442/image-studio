            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 border-l-4 border-primary bg-muted/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Images generated by our AI services are temporarily stored on our servers for up to 1 hour to allow you to download them. 
                    You have full control to delete any of your generated images at any time through our interface.
                  </p>
                </div>
              </div>
            </section>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700 dark:text-blue-300">
                          Generated images are stored temporarily (maximum 1 hour) to allow you to download them.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700 dark:text-blue-300">
                          Our system automatically deletes all images after 1 hour to protect your privacy.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-medium text-blue-800 dark:text-blue-200">Manual Cleanup</h4>
                        <p className="text-sm text-blue-700 dark:text-blue-300">
